# Original: https://raw.githubusercontent.com/avivace/iosevka-docker/master/Dockerfile
# The only change is, added local user(line 20) to avoid permission hell.
...
# Add user with root group for convenience.
